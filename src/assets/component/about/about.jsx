        ...
        <>
            ...
            <div className=" w-full overflow-hidden md:p-16 p-4">
                ...
                <div data-aos="zoom-in-down" className="flex justify-center ">
                    <div className="underline text-xl md:text-2xl lg:text-3xl p-8 text-indigo-700 font-extrabold">About us</div>
                </div>

                <div className="flex flex-col md:items-center  gap-32 ">

                <div data-aos="fade-up" data-aos-duration="1000" className="bg-gradient-to-l from-green-200  to-gray-200 flex flex-col md:w-[700px] lg:w-[800px] justify-center shadow-lg p-16 lg:-ml-24 ">
                    ...
                    <div data-aos="flip-up" className="bg-gradient-to-l from-green-200  to-gray-200 flex flex-col md:w-[700px] lg:w-[800px] justify-center shadow-lg p-16 lg:ml-24 ">
